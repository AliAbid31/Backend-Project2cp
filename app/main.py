...
# Allow running from the app directory while keeping absolute imports working
...
from app.routes import (
    students, teachers, parents, users, reports, evaluation, 
    documents, session, quotes, services, messages, 
    notifications, email_verification, admin, auth, autth1, chatbot
)
